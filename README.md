...
`Babylon.js 기준선`를 단일 질문으로 분리해 검증하는 experiment 저장소입니다. 하나의 가설과 baseline에 집중하고, 결과를 재현 가능한 형식으로 남겨 이후 benchmark/app 저장소의 입력으로 사용합니다.
...
## 핵심 질문
- Babylon.js 기준선를 브라우저/WebGPU 환경에서 재현 가능한 baseline으로 만들 수 있는가
...
- Repo-specific Pages baseline copied from `repo-scaffolds/repos/exp-babylon-webgpu-core/`
...
## 현재 baseline 상태
- Repository-specific runnable baseline active: Babylon-style scene readiness harness with capability probe, material/submesh metadata, and schema-aligned graphics result export
- Generated override source: `repo-scaffolds/repos/exp-babylon-webgpu-core/`
- Results/report scaffold is ready to promote exported JSON into `reports/raw/` and `RESULTS.md`

## GitHub Pages 운영 메모
- Pages URL: https://ai-webgpu-lab.github.io/exp-babylon-webgpu-core/
...
- 이 저장소의 live demo는 `https://ai-webgpu-lab.github.io/exp-babylon-webgpu-core/`입니다.
